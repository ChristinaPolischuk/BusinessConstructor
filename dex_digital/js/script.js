...
(function () {
  ...
  ;
  var circle = document.querySelector(".progress-bar__circle");
  ...
  $(window).scroll(function () {
    ...
    var et = $(".progress-bar").offset().top;
    var eh = $(".progress-bar").outerHeight();
